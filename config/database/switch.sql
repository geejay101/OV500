...
-- ----------------------------
-- Records of carrier_daily_usage
-- ----------------------------
...
-- ----------------------------
-- Records of customer_daily_usages
-- ----------------------------
...
-- ----------------------------
-- Table structure for `customer_ratesdump`
-- ----------------------------
DROP TABLE IF EXISTS `customer_ratesdump`;
CREATE TABLE `customer_ratesdump` (
  `rate_id` int(11) NOT NULL AUTO_INCREMENT,
  `ratecard_id` varchar(30) NOT NULL,
  `prefix` varchar(25) NOT NULL,
  `destination` varchar(150) NOT NULL,
...
-- ----------------------------
-- Table structure for `did_dstdump`
-- ----------------------------
DROP TABLE IF EXISTS `did_dstdump`;
CREATE TABLE `did_dstdump` (
  `did_dst_id` int(11) NOT NULL AUTO_INCREMENT,
  `did_number` varchar(30) DEFAULT NULL,
  `account_id` varchar(30) DEFAULT NULL,
  `dst_type` enum('IP','CUSTOMER','PSTN') DEFAULT 'IP',
...
-- ----------------------------
-- Records of did_dstdump
-- ----------------------------

-- ----------------------------
-- Table structure for `diddump`
-- ----------------------------
DROP TABLE IF EXISTS `diddump`;
CREATE TABLE `diddump` (
