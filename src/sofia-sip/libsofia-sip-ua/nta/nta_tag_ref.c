...
extern tag_typedef_t ntatag_max_recv_requests_per_second;
EXPORT tag_typedef_t ntatag_max_recv_requests_per_second_ref = 
  REFTAG_TYPEDEF(ntatag_max_recv_requests_per_second);
...
extern tag_typedef_t ntatag_tls_orq_connect_timeout;
EXPORT tag_typedef_t ntatag_tls_orq_connect_timeout_ref = 
  REFTAG_TYPEDEF(ntatag_tls_orq_connect_timeout);
...
EXPORT tag_typedef_t ntatag_intercept_query_results_ref = 
  REFTAG_TYPEDEF(ntatag_intercept_query_results);
extern tag_typedef_t ntatag_q_in_completed;
EXPORT tag_typedef_t ntatag_q_in_completed_ref = 
  REFTAG_TYPEDEF(ntatag_q_in_completed);
extern tag_typedef_t ntatag_q_in_final_failed;
EXPORT tag_typedef_t ntatag_q_in_final_failed_ref = 
  REFTAG_TYPEDEF(ntatag_q_in_final_failed);
extern tag_typedef_t ntatag_q_in_inv_completed;
EXPORT tag_typedef_t ntatag_q_in_inv_completed_ref = 
  REFTAG_TYPEDEF(ntatag_q_in_inv_completed);
extern tag_typedef_t ntatag_q_in_inv_confirmed;
EXPORT tag_typedef_t ntatag_q_in_inv_confirmed_ref = 
  REFTAG_TYPEDEF(ntatag_q_in_inv_confirmed);
extern tag_typedef_t ntatag_q_in_preliminary;
EXPORT tag_typedef_t ntatag_q_in_preliminary_ref = 
  REFTAG_TYPEDEF(ntatag_q_in_preliminary);
extern tag_typedef_t ntatag_q_in_proceeding;
EXPORT tag_typedef_t ntatag_q_in_proceeding_ref = 
  REFTAG_TYPEDEF(ntatag_q_in_proceeding);
extern tag_typedef_t ntatag_q_in_terminated;
EXPORT tag_typedef_t ntatag_q_in_terminated_ref = 
  REFTAG_TYPEDEF(ntatag_q_in_terminated);
extern tag_typedef_t ntatag_q_out_completed;
EXPORT tag_typedef_t ntatag_q_out_completed_ref = 
  REFTAG_TYPEDEF(ntatag_q_out_completed);
extern tag_typedef_t ntatag_q_out_delayed;
EXPORT tag_typedef_t ntatag_q_out_delayed_ref = 
  REFTAG_TYPEDEF(ntatag_q_out_delayed);
extern tag_typedef_t ntatag_q_out_inv_calling;
EXPORT tag_typedef_t ntatag_q_out_inv_calling_ref = 
  REFTAG_TYPEDEF(ntatag_q_out_inv_calling);
extern tag_typedef_t ntatag_q_out_inv_completed;
EXPORT tag_typedef_t ntatag_q_out_inv_completed_ref = 
  REFTAG_TYPEDEF(ntatag_q_out_inv_completed);
extern tag_typedef_t ntatag_q_out_inv_proceeding;
EXPORT tag_typedef_t ntatag_q_out_inv_proceeding_ref = 
  REFTAG_TYPEDEF(ntatag_q_out_inv_proceeding);
extern tag_typedef_t ntatag_q_out_resolving;
EXPORT tag_typedef_t ntatag_q_out_resolving_ref = 
  REFTAG_TYPEDEF(ntatag_q_out_resolving);
extern tag_typedef_t ntatag_q_out_terminated;
EXPORT tag_typedef_t ntatag_q_out_terminated_ref = 
  REFTAG_TYPEDEF(ntatag_q_out_terminated);
...
EXPORT tag_type_t nta_tag_list[] =
{
  ...
  ntatag_comp,
  ntatag_max_recv_requests_per_second,
  ntatag_s_leg_hash,
  ntatag_srv_503,
  ...
  ntatag_q_in_inv_completed,
  ntatag_s_tout_request,
  ntatag_sip_t1,
  ntatag_sip_t2,
  ntatag_q_in_preliminary,
  ntatag_remote_cseq,
  ntatag_ua,
  ntatag_sip_t4,
  ntatag_server_rport,
  ntatag_q_in_terminated,
  ntatag_smime,
  ntatag_timeout_408,
  ntatag_debug_drop_prob,
  ntatag_ack_branch,
  ntatag_method,
  ntatag_q_in_completed,
  ntatag_cancel_2543,
  ntatag_timer_c,
  ntatag_blacklist,
  ntatag_s_bad_request,
  ntatag_default_proxy,
  ntatag_q_in_inv_confirmed,
  ntatag_aliases,
  ...
  ntatag_max_forwards,
  ntatag_q_out_resolving,
  ntatag_s_recv_response,
  ntatag_q_out_terminated,
  ntatag_q_in_proceeding,
  ntatag_tcp_rport,
  ...
  ntatag_cancel_408,
  ntatag_user_via,
  ntatag_q_out_inv_calling,
  ntatag_s_trless_200,
  ntatag_s_acked_tr,
  ntatag_stateless,
  ntatag_use_srv,
  ntatag_graylist,
  ntatag_q_in_final_failed,
  ...
  ntatag_pass_100,
  ntatag_tls_orq_connect_timeout,
  ntatag_intercept_query_results,
  ntatag_s_canceled_tr,
  ntatag_progress,
  ntatag_incomplete,
  ntatag_q_out_inv_proceeding,
  ntatag_q_out_inv_completed,
  ...
  ntatag_q_out_completed,
  ntatag_s_tout_response,
  ntatag_sipflags,
  ntatag_contact,
  ntatag_use_timestamp,
  ntatag_q_out_delayed,
  NULL
};
