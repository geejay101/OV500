...
extern tag_typedef_t nutag_call_tls_orq_connect_timeout;
EXPORT tag_typedef_t nutag_call_tls_orq_connect_timeout_ref = 
  REFTAG_TYPEDEF(nutag_call_tls_orq_connect_timeout);
extern tag_typedef_t nutag_intercept_query_results;
EXPORT tag_typedef_t nutag_intercept_query_results_ref = 
  REFTAG_TYPEDEF(nutag_intercept_query_results);
...
extern tag_typedef_t nutag_auto_invite_100;
EXPORT tag_typedef_t nutag_auto_invite_100_ref = 
  REFTAG_TYPEDEF(nutag_auto_invite_100);
